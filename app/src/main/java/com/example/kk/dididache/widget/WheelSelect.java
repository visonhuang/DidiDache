...
public class WheelSelect {
    ...
    public void onDraw (Canvas canvas) {
        ...
        LinearGradient bottom = new LinearGradient(0,0,0,startY / 2 + 2 ,0x00bcd2fa,0xffbcd2fa,Shader.TileMode.REPEAT);
        shadow.setShader(bottom);
      //  canvas.drawRect(0,startY + height * 3 / 2,width - padding,startY + height * 2,shadow);
        canvas.drawRect(0,startY + height * 2 - startY / 2,width - padding,startY + height * 2 + 2,shadow);
